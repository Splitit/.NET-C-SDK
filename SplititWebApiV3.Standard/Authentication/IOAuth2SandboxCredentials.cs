// <copyright file="IOAuth2SandboxCredentials.cs" company="APIMatic">
...
{
    public interface IOAuth2SandboxCredentials
    {
        /// <summary>
        ...
        /// </summary>
        List<Models.OAuthScopeOAuth2SandboxEnum> OAuthScopes { get; }
        ...
        bool Equals(string oAuthClientId, string oAuthClientSecret, Models.OAuthToken oAuthToken, List<Models.OAuthScopeOAuth2SandboxEnum> oAuthScopes);
