// <copyright file="OAuth2SandboxManager.cs" company="APIMatic">
...
{
    /// <summary>
    /// OAuth2SandboxManager Class.
    /// </summary>
    public class OAuth2SandboxManager : AuthManager, IOAuth2SandboxCredentials
    {
        private readonly Func<OAuthAuthorizationController> getOAuthController;

        /// <summary>
        /// Initializes a new instance of the <see cref="OAuth2SandboxManager"/> class.
        /// </summary>
        /// <param name="oAuth2Sandbox"> OAuth 2 Client Cridentials Model.</param>
        /// <param name="getOAuthController">A function that provides an instance of <see cref="OAuthAuthorizationController"/>.</param>
        internal OAuth2SandboxManager(OAuth2SandboxModel oAuth2Sandbox,
            Func<OAuthAuthorizationController> getOAuthController)
        {
            OAuthClientId = oAuth2Sandbox?.OAuthClientId;
            OAuthClientSecret = oAuth2Sandbox?.OAuthClientSecret;
            OAuthToken = oAuth2Sandbox?.OAuthToken;
            OAuthScopes = oAuth2Sandbox?.OAuthScopes;
            this.getOAuthController = getOAuthController;
            OAuthClockSkew = oAuth2Sandbox?.OAuthClockSkew;
            OAuthTokenProvider = oAuth2Sandbox?.OAuthTokenProvider;
            OAuthOnTokenUpdate = oAuth2Sandbox?.OAuthOnTokenUpdate;
            OAuthTokenAutoRefresh = oAuth2Sandbox?.OAuthToken;
        }
        ...
        /// <summary>
        /// Gets List of Models.OAuthScopeOAuth2SandboxEnum value for oAuthScopes.
        /// </summary>
        public List<Models.OAuthScopeOAuth2SandboxEnum> OAuthScopes { get; }
        ...
        /// </summary>
        public Func<OAuth2SandboxManager, OAuthToken, Task<OAuthToken>> OAuthTokenProvider { get; }
        ...
        /// <param name="oAuthScopes"> The List of Models.OAuthScopeOAuth2SandboxEnum value for credentials.</param>
        /// <returns> True if credentials matched.</returns>
        public bool Equals(string oAuthClientId, string oAuthClientSecret, Models.OAuthToken oAuthToken, List<Models.OAuthScopeOAuth2SandboxEnum> oAuthScopes)
        {
        ...
        {
            var token = await getOAuthController().RequestTokenOAuth2SandboxAsync(BuildBasicAuthHeader(), this.OAuthScopes.GetValues(), additionalParameters).ConfigureAwait(false);
    ...
    public sealed class OAuth2SandboxModel
    {
        internal OAuth2SandboxModel()
        {
        }
        ...
        internal List<Models.OAuthScopeOAuth2SandboxEnum> OAuthScopes { get; set; }

        internal TimeSpan? OAuthClockSkew { get; set; }

        internal Func<OAuth2SandboxManager, OAuthToken, Task<OAuthToken>> OAuthTokenProvider { get; set; }

        internal Action<OAuthToken> OAuthOnTokenUpdate { get; set; }

        /// <summary>
        /// Creates an object of the OAuth2SandboxModel using the values provided for the builder.
        /// </summary>
        ...
        /// <summary>
        /// Builder class for OAuth2SandboxModel.
        /// </summary>
        public class Builder
        {
            ...
            private List<Models.OAuthScopeOAuth2SandboxEnum> oAuthScopes;
            private TimeSpan? oAuthClockSkew;
            private Func<OAuth2SandboxManager, OAuthToken, Task<OAuthToken>> oAuthTokenProvider;
            ...
            /// <returns>Builder.</returns>
            public Builder OAuthScopes(List<Models.OAuthScopeOAuth2SandboxEnum> oAuthScopes)
            {
            ...
            /// <returns>Builder.</returns>
            public Builder OAuthTokenProvider(Func<OAuth2SandboxManager, OAuthToken, Task<OAuthToken>> oAuthTokenProvider)
            {
            ...
            /// Creates an object of the OAuth2SandboxModel using the values provided for the builder.
            /// </summary>
            /// <returns>OAuth2SandboxModel.</returns>
            public OAuth2SandboxModel Build()
            {
                return new OAuth2SandboxModel()
                {
