// <copyright file="IOAuth2ProductionCredentials.cs" company="APIMatic">
...
{
    public interface IOAuth2ProductionCredentials
    {
        /// <summary>
        ...
        /// </summary>
        List<Models.OAuthScopeOAuth2ProductionEnum> OAuthScopes { get; }
        ...
        bool Equals(string oAuthClientId, string oAuthClientSecret, Models.OAuthToken oAuthToken, List<Models.OAuthScopeOAuth2ProductionEnum> oAuthScopes);
